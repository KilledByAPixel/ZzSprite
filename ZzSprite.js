...
function ZzSprite(context, x, y, seed, size=16, mode=0, mutateSeed=0, colorSeed=0)
{
    ...
    // apply mutations
    randomSeed = seed+mutateSeed+1e8;
